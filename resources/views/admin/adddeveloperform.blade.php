    ...
    <body>
        ...
        <!-- @csrf                           
            <div class="col-sm-3">
                ...
                <label class="cstm-name  ">Location</label><br>
                <input type="text" class="frm-custom"  name="location[]" required><br>

                <label class="cstm-name  ">Agents</label><br>
                <input type="text" class="frm-custom" name="agants[]" required><br>

                <label class="cstm-name  ">Amenities List:</label><br>
                <input type="text" class="frm-custom" name="amenitiesList[]"><br>

                <label class="cstm-name  ">Amenities Nearby:</label><br>
                <input type="text" class="frm-custom" name="amenitiesNearby[]"><br>
            ...
            <div class="col-sm-4">
                ...
                <label class="cstm-name  ">PropePropertyrty Descriptions*</label><br>
                ...
                <div class="row">
                    @csrf
                        ...
                        <div class="col-4">
                            ...
                            <label class="cstm-name badge badge-secondary">Logo:</label>
                            <div class="form-group">  
                                <input type="file" class="form-control" required name="devlogo[]" multiple>
                            </div>
                        </div>
                        <div class="col-4">
